...
//Adjusting the nav bar code for all pages
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!currentPage.includes("Home.aspx") && !currentPage.includes("Home")) {
        // Remove existing classes from navbar
        navbar.classList.remove('navbar')

        // Add class 'navbar2' to navbar
...
document.addEventListener("DOMContentLoaded", function () {
    if (window.location.pathname.includes("Home.aspx") || window.location.pathname.includes("Home")) {
        window.onscroll = function () {
...
function goBack() {
    window.location.href = '../Website/Home.aspx'; // Replace '/' with the URL of your home page
}
